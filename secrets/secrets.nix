let
  keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEGqp43D9SJW++CgmTJv7NS+nmaPBs6Lglv9SXu7BiUx" # rikako
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIP+QM7/0TCdDoX+jhp0dpnKfGxvJV5ofkZewJHztsMT8" # yukari host
  ];
  workkeys = [
